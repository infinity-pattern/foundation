...
struct Version {
  ...
  constexpr auto
  operator<=>(Version const &that) const noexcept = default;
};
...
template <> struct std::formatter<infinity::foundation::Version> {
  ...
  constexpr auto format(infinity::foundation::Version const &version, FormatContext &context) const
      -> FormatContext::iterator {
    return std::format_to(context.out(), "{}.{}.{}.{}", version.major,
                          version.minor, version.patch, version.tweak);
  }
};
...
template <> struct std::formatter<infinity::foundation::Build> {
  ...
  template <class FormatContext> constexpr auto format (infinity::foundation::Build const &build, FormatContext &context) const
      -> FormatContext::iterator {
    return std::format_to(context.out(),
                          "version: [{}]\n revision: [{}]\n built on: [{}]",
                          build.version, build.describe, build.timestamp);
  }
};
